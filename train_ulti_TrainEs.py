...
# from my_alexnet import netReg
from SDCNN import netReg
# from KL import netReg
...
def main():  # 单独使用main函数是为了避免使用全局变量, 是接口更严谨
    ...
    copyfile(model_alex_name, os.path.join(saveFolder, model_alex_name))
