...
wc_t2_s = [0.893, 0.906, 0.899, 0.893]
wc_t2_p = [0.873, 0.888, 0.878, 0.868]
...
wc_t3_s = [0.903, 0.901, 0.897, 0.898, 0.896]
wc_t3_p = [0.875, 0.878, 0.880, 0.885, 0.873]

ck_t3_s = [0.897, 0.899]
ck_t3_p = [0.875, 0.874]

pc_t3_s = [0.904, 0.892, 0.900]
pc_t3_p = [0.889, 0.866, 0.878]
...
# plt.plot(mt_s, marker='o', label='proposed', ls='-')
...
# plt.plot(mn_s, marker='x', label='baseline', ls='--')
...
ax_sns = sns.lineplot(data=srcc_df)
plt.show()
...
# plt.plot(mt_p, marker='o', label='proposed', ls='-')
...
mnp = [mn1_p, mn2_p, mn3_p, mn4_p]
# plt.plot(mnp, marker='x', label='baseline', ls='--')
