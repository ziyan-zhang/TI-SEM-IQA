...
def get_index(N, Number, num_sample=5):
    """
    ...
    return sample(range(N_start, N_end), num_sample)
...
for c in range(10000000):
    ...
    for mat_path in mat_paths:
        ...
        the_index = get_index(0.1, dict_len)
    ...
    No_index = ['No1820', 'No7280', 'No25480', 'No101920', 'No407680']
    ...
    if READY:
        ...
        plot_with_ebar_mean_std(No_srcc_mean, No_srcc_std, No_plcc_mean, No_plcc_std, 'shiyan', 'performance', save_dir,
                                mode='ebar_with_cap_new', fontsize=13, vertical_bias=6e-4)
