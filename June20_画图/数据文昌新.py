# -*- coding: utf-8 -*-
# 创建日期  : 2020/8/11 20:22 -> ZhangZiyan
# 项目     : June20_画图 -> 数据文昌新
# 描述     :  
# 待办     :  
...
# 新数据
# T100_s = [0.9104, 0.9105, 0.9075, 0.9210, 0.9077, 0.9173, 0.9039, 0.9159, 0.9098, 0.9188, 0.9057, 0.9096, 0.9110, 0.9157, 0.9104, 0.9107]
T100_s = [0.9104, 0.9105, 0.9173, 0.9159, 0.9098, 0.9188, 0.9096, 0.9110, 0.9157, 0.9104, 0.9107]
...
N100_s = [0.8964, 0.8878, 0.8899, 0.8898, 0.8941, 0.8950, 0.8940, 0.8980, 0.8931, 0.8978, 0.8910]
...
T80_s = [0.9083, 0.9028, 0.9034, 0.9021, 0.9081, 0.9028, 0.9034, 0.9076, 0.9082, 0.9082, 0.9038]
mT80_s = np.array(T80_s).mean()
# plt.plot(T80_s-mT80_s)
# plt.show()
...
N80_s = [0.8840, 0.8848, 0.8910, 0.8865, 0.8897, 0.8946, 0.8906, 0.8855, 0.8877, 0.8864, 0.8850]
mN80_s = np.array(N80_s).mean()
plt.plot(N80_s-mN80_s)
plt.show()
...
T60_s = [0.9095, 0.8995, 0.9008, 0.8903, 0.8947, 0.9101, 0.9044, 0.9044, 0.9100, 0.9097, 0.9079, 0.8980, 0.9033]
